...
authRouter.patch("/update-annual-qualification/:id", uploadannualQualification.uploadSingleAnnual, updateHPCNAQualification);
authRouter.patch("/update-primary-qualification/:id", uploadprimaryQualification.uploadSinglePrimary, updateFinalQualification);
authRouter.patch("/update-prescribing-certificate/:id", uploadPrescribingCertificate.uploadPrescribingCertificate, updateDispensingCertificateLicence);
